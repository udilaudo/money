...
class Wallet:
    ...
    def plot(self):
        ...
        sns.barplot(x='Category', y='Amount', data=temp_df, hue='Type', dodge=False, palette=['#FF6347', '#1E90FF'])
    ...
    def plot_time(self):
        ...
        sns.set_theme(style="whitegrid")
        plt.figure(figsize=(10, 6))
        sns.barplot(x='Date', y='Amount', data=temp_df, hue='Type', dodge=False, palette=['#FF6347', '#1E90FF'])
